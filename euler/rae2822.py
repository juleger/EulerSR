...
def rae2822_contour(n_pts: int = 300, chord: float = 1.0,
                    x0: float = 0.0, y0: float = 0.0) -> np.ndarray:
    """Contour RAE 2822 sens trigonométrique, sans point dupliqué (BA et BF).
    PCHIP : interpolation monotone, pas d'oscillation de Runge au bord de fuite.
    """
